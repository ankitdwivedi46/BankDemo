...
class DBInsertCustomerCredential:
    ...
    def insertDBCustomerCred(self, obj):
        ...
        SQL_QUERY = "INSERT INTO CUSTOMER_CREDENTIAL_DATABANK(CUSTOMER_ACC_NO,CUSTOMER_USERNAME,CUSTOMER_PASSWORD,CUSTOMER_PIN,CUSTOMER_FIRST_LOGIN_FLAG,DECRYPT_KEY) VALUES('{}','{}','{}','{}','{}','{}')".format(
            str(credObj.get_cust_acc_no()),str(credObj.get_cust_username()),ciphered_text.decode("utf-8"),str(credObj.get_cust_pin()),"T",key.decode("utf-8")
        )
