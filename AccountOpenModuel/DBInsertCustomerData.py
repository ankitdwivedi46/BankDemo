...
class DBInsertCustomerData:
    ...
    def insertDBCustomerData(self,obj):
        ...
        SQL_QUERY = "CREATE TABLE CUSTOMER_{} (CUSTOMER_ACC_NO NVARCHAR(36),CHANGE_AMOUNT NVARCHAR(50) NOT NULL,CREDIT_FLAG CHAR(1) NOT NULL,DEBIT_FLAG CHAR(1) NOT NULL, MODIFIED_TIME NVARCHAR(50) NOT NULL, ACC_BALANCE NVARCHAR(50) NOT NULL )".format(str(openAcc.get_cust_acc_no()))
